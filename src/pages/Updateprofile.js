...
import { FaUserEdit, FaTimes, FaArrowLeft, FaQrcode } from 'react-icons/fa';
...
export default function ProfileEdit() {
  ...
  return (
    <div className="min-h-screen imgbg bg-[#0a0f07] text-white px-4 pt-10 pb-8 w-full max-w-md mx-auto font-sans relative">
      ...
      <div className="flex flex-col items-center mb-10">
        <div className="relative w-28 h-28">
          <div className="w-full h-full rounded-full bg-[#1efcb9]/20 flex items-center justify-center text-5xl">
            <img src="/assets/klink4.svg" alt="Profile" style={{ width: '100%' }} />
          </div>
        </div>
      </div>
      ...
      <p className="flex items-center gap-2 px-4 py-3 border border-white/10 rounded-xl">{userInfo.email}</p>
